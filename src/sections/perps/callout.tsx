	...
	return (
		<Flex as="section" direction="column">
			...
			<Text fontWeight="700" fontSize="36px" lineHeight="40px" maxW="800px">
				...
				permissionless and decentralized smart contracts, offering deep
				liquidity and low trading fees on a range of synthetic assets. Third
				party integrators have decided to integrate with Synthetix.
			</Text>
		</Flex>
	);
}
