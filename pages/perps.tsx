		...
		<>
			...
			<PageLayout useChakra>
				...
				<Flex
					...
					alignItems="center"
					w="100vw"
					bg="radial-gradient(circle at left 600px, rgba(238, 46, 255, 0.2) 4%, transparent, transparent 50%),
					radial-gradient(circle at right 700px, rgba(0, 209, 255, 0.2) 3%, transparent, transparent 50%)"
				>
					<Action />
					<FrontEnds />
				</Flex>
