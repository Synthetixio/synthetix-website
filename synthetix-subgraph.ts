...
export const getDailySNXPriceById = async function <K extends keyof DailySNXPriceResult>(url: string, options: SingleQueryOptions, args: DailySNXPriceArgs<K>): Promise<Pick<DailySNXPriceResult, K>> {
    const res = await axios.post(url, {
    ...
    if (obj["averagePrice"])
        formattedObj["averagePrice"] = wei(obj["averagePrice"]);
    return formattedObj as Pick<DailySNXPriceResult, K>;
};
export const getDailySNXPrices = async function <K extends keyof DailySNXPriceResult>(url: string, options: MultiQueryOptions<DailySNXPriceFilter, DailySNXPriceResult>, args: DailySNXPriceArgs<K>): Promise<Pick<DailySNXPriceResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<DailySNXPriceFilter, DailySNXPriceResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof DailySNXPriceFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFifteenMinuteSNXPriceById = async function <K extends keyof FifteenMinuteSNXPriceResult>(url: string, options: SingleQueryOptions, args: FifteenMinuteSNXPriceArgs<K>): Promise<Pick<FifteenMinuteSNXPriceResult, K>> {
    const res = await axios.post(url, {
...
export const getFifteenMinuteSNXPrices = async function <K extends keyof FifteenMinuteSNXPriceResult>(url: string, options: MultiQueryOptions<FifteenMinuteSNXPriceFilter, FifteenMinuteSNXPriceResult>, args: FifteenMinuteSNXPriceArgs<K>): Promise<Pick<FifteenMinuteSNXPriceResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FifteenMinuteSNXPriceFilter, FifteenMinuteSNXPriceResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FifteenMinuteSNXPriceFilter;
        paginatedOptions.where = { ...options.where };
    }
